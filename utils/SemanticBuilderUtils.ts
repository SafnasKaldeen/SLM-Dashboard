  ...
  static getOrganizationCatalog(): Catalog {
    ...
    const tableDefs = [
      ...
      { 
        ...
        columns: ["PAYMENT_ID", "PAYMENT_METHOD_ID", "APPROVED_SWAP_ID", "CUSTOMER_ID", "RATING_ID", "PAYMENT_METHOD", "PAYMENT_STATUS", "AMOUNT", "CURRENCY", "TRANSACTION_ID", "LOCATION_NAME", "STATION_NAME", "PAID_AT", "CREATED_AT", "AMOUNT_PAID", "CHARGE_AMOUNT", "CHARGE_PERCENTAGE", "REFUND_AMOUNT", "REFUND_PERCENTAGE", "PAYMENT_TRIES", "PREVIOUS_WALLET_BAL", "WALLET_BALANCE", "WALLET_MIN_BAL", "WALLET_CODE", "PAYMENT_METHOD_TYPE", "PAYMENT_TYPE", "REASON", "AGREEMENT", "EVENT_CODE", "EVENT_MSG", "CREATED_EPOCH", "DETAILS_JSON"] 
      },
      { 
        name: "FACT-TBOX-GPS", 
